...
var SimpleDateSelector = function (_React$Component) {
  _inherits(SimpleDateSelector, _React$Component);

  function SimpleDateSelector(props) {
    _classCallCheck(this, SimpleDateSelector);

    var _this = _possibleConstructorReturn(this, (SimpleDateSelector.__proto__ || Object.getPrototypeOf(SimpleDateSelector)).call(this, props));

    _this.onDateChange = function (e) {
      var currentValue = (0, _dayjs2.default)(e.target.value).format(_this.props.format);
      _this.setState({ currentValue: currentValue }, function () {
  ...
  _createClass(SimpleDateSelector, [{
    key: 'render',
...
SimpleDateSelector.defaultProps = {
  disabled: false,
  value: (0, _dayjs2.default)(),
  format: "YYYY-MM-DD"
};

exports.default = SimpleDateSelector;
...
var _SimpleDateSelector = __webpack_require__(2);

var _SimpleDateSelector2 = _interopRequireDefault(_SimpleDateSelector);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _SimpleDateSelector2.default;
